                                ...
                                <div class="mb-5">
                                    <div class="row">
                                        <div class="col-md-12 mb-3">
                                            <h6>Site's name</h6>
                                            <input type="text" name="sitename" class="form-control" id="sitename" placeholder="Your site's name">
                                        </div>
                                        <div class="col-md-12">
                                            <h6>Color theme</h6>
                                            <input type="color" name="sitecolor" class="form-control form-control-color" id="sitecolor"  value="#ffffff" title="Choose your color">
                                        </div>
                                    </div>
                                </div>
                            </div>
