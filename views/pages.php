...
if (isset($_GET['s'])) {
    $posts = $auth->getAllPosts('%' . $_GET['s'] . '%', 'pages');
    $query = $_GET['s'];
} else {
    $posts = $auth->getAllPosts('%%', 'pages');
    $query = '';
}
                ...
                <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3">
                    ...
                    <form action="" method="get" class="form-inline mb-2">
						<div class="form-group d-flex justify-content-center flex-nowrap align-items-center">
							<a class="btn btn-circle me-3" href="post-add?kind=pages"><i class="bi bi-plus-lg fa-lg"></i></a>
                    ...
                    <div class="shadow p-4 p-xxl-5 mb-5 bg-body rounded border mt-xxl-5 mx-xxl-5">
                        ...
                        <div class="row">
                            ...
                            <div class="col-auto">
                                ...
                                <?php echo pagination($posts, $allpage, $curent_page, 'pages', ['s']); ?>
