...
$output .= '<section'. $block_id .' class="lift-elements lift-' . $this->name . $theme . $css_class .''.($add_box_button ? ' lift-hold-click' : '').$applyMargin.$initial_loading_animation.'"' . str_replace('``', '', $attribute) . '>';
...
$output .= '<article class="lift-ctn'.$textAlign.$applyPadding.'"'.$getGoogleFont.'>';
