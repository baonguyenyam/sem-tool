...
if (!class_exists('liftVC_Addons_BoxInfo')) {
	...
	class liftVC_Addons_BoxInfo extends LIFT_Helpers
	{
		...
		public function functionLoader()
		{
			return array(
				...
				'params'      => array(
					...
					// 	'type'       => 'attach_image',
					// 	'holder' => 'img_back',
					// 	'heading' => __('Image hover', 'js_composer'),
					// 	'param_name' => 'bgimg_hover',
					// 	'class' => 'lift-bgimg',
					// 	'weight' => 0,
					// 	'edit_field_class' => 'vc_col-sm-6 admin-lift-col pt-0',
					// 	'group' => __('Images & Icons', 'js_composer')
		...
		public function output($atts, $content = null)
		{
			...
			// $image_hover_src = wp_get_attachment_image_src($atts['bgimg_hover'], $atts['img_size'])[0];
			...
			$css_build .= $desc_color ? $cssname.' .lift-ctn .lift-content{color:'.$desc_color.'}' : null;
			$css_build .= $applyDesc ? $cssname.' .lift-ctn .lift-content{'.$applyDesc.'}' : null;
			$css_build .= $applyHeadingStyle ? $cssname.' .lift-ctn .lift-title{'.$applyHeadingStyle.'}' : null;
			$css_build .= $applyHeadingStyle ? $cssname.' .lift-ctn .lift-title .lift-title-link{'.$applyHeadingStyle.'}' : null;
			$css_build .= $getGoogleFont ? $cssname.' {'.$getGoogleFont.'}' : null;
			$css_build .= $getGoogleFont ? $cssname.' .lift-ctn .lift-title{'.$getGoogleFont.'}' : null;
			$css_build .= $getGoogleFont ? $cssname.' .lift-ctn .lift-title{'.$getGoogleFont.'}' : null;
			$css_build .= $icon_size ? $cssname.' .lift-ctn .lift-icon{'.$applyIconStyle.'}' : null;
			// BUTTON 
			$css_build .= $btn_color ? ''. $cssname.' .lift-button >*{color:'.$btn_color.'}' : null;
			$css_build .= $btn_bg ? ''. $cssname.' .lift-button >*{background-color:'.$btn_bg.'}' : null;
			$css_build .= $btn_border_color ? ''. $cssname.' .lift-button >*{border-color:'.$btn_border_color.'}' : null;
			$css_build .= $btn_border ? ''. $cssname.' .lift-button >*{border-style:solid!important;border-width:'.$btn_border.'px!important;}' : null;
			if($btn_border_style) {
			...
			$css_build .= $btn_transparent ? ''. $cssname.' .lift-button >*{opacity:'.$btn_transparent.';}' : null;
			...
			if($add_box_button){
				$css_build .= $btn_hover_color ? ''. $cssname.':hover .lift-button >*{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.':focus .lift-button >*{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.':active .lift-button >*{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':hover .lift-button >*{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':focus .lift-button >*{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.':active .lift-button >*{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':hover .lift-button >*{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':focus .lift-button >*{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.':active .lift-button >*{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.':hover .lift-button >*{opacity:'.$btn_transparent_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.':focus .lift-button >*{opacity:'.$btn_transparent_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.':active .lift-button >*{opacity:'.$btn_transparent_hover.'}' : null;
			} else {
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:hover{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:focus{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_color ? ''. $cssname.' .lift-button >*:active{color:'.$btn_hover_color.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:hover{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:focus{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_hover_bg ? ''. $cssname.' .lift-button >*:active{background-color:'.$btn_hover_bg.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:hover{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:focus{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_border_hover ? ''. $cssname.' .lift-button >*:active{border-color:'.$btn_border_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.' .lift-button >*:hover{opacity:'.$btn_transparent_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.' .lift-button >*:focus{opacity:'.$btn_transparent_hover.'}' : null;
				$css_build .= $btn_transparent_hover ? ''. $cssname.' .lift-button >*:active{opacity:'.$btn_transparent_hover.'}' : null;
			}

			$css_build .= $text_color_hover ? ''. $cssname.':hover .lift-ctn .lift-title{color:'.$text_color_hover.';}' : null;
			$css_build .= $text_color_hover ? ''. $cssname.':hover .lift-ctn .lift-title .lift-title-link{color:'.$text_color_hover.';}' : null;
			$css_build .= $desc_color_hover ? ''. $cssname.':hover .lift-ctn .lift-content{color:'.$desc_color_hover.';}' : null;
			...
			$css_build .= $box_hover_bg ? ''. $cssname.':hover {background-color:'.$box_hover_bg.'!important;}' : null;
			$css_build .= $box_border_hover ? ''. $cssname.':hover {border-color:'.$box_border_hover.'!important;}' : null;
