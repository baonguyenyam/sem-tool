...
function lift_create_posttype_cp_LIFT_WP_CP() {
	...
	array(	
		'label' => $shortname,
		'description' => 'Create content '.$shortname.'s which can be used in posts, pages and widgets.',
		'public' => true,
		'show_ui' => true,
		...
		'supports' => array(
			...
			'labels' => array (
				...
				'singular_name' => $slug,
				'menu_name' => $name,
				'add_new' => 'Add '.$shortname.'',
				'add_new_item' => 'Add New '.$shortname.'',
				'new_item' => 'New '.$shortname.'',
				'edit' => 'Edit',
				'edit_item' => 'Edit '.$shortname.'',
				'view' => 'View '.$shortname.'',
				'view_item' => 'View '.$shortname.'',
				'search_items' => 'Search '.$shortname.'',
				'not_found' => 'No '.$shortname.'s Found',
				'not_found_in_trash' => 'No '.$shortname.'s Found in Trash',
