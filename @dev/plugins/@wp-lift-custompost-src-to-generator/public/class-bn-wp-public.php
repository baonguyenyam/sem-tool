...
class LIFT_WP_CP_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in LIFT_WP_CP_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The LIFT_WP_CP_Loader will then create the relationship
