...
if ( !class_exists( 'LIFT_Addons_All_in_One' ) ) {
    final class LIFT_Addons_All_in_One
    {
        ...
        public function load_frontend_scripts() {
            ...
            wp_register_script('wpb_composer_front_js', plugin_dir_url( __FILE__ ) . 'assets/js/js_composer_front.min.js', array('jquery'));
            wp_enqueue_script('wpb_composer_front_js');
            wp_register_script('waypoints', plugin_dir_url( __FILE__ ) . 'assets/js/waypoints.min.js', array('jquery'));
