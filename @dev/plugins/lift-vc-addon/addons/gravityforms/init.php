...
if (!class_exists('liftVC_Addons_GravityForms')) {
	...
	class liftVC_Addons_GravityForms extends LIFT_Helpers
	{
		...
		public function output($atts, $content = null)
		{
			...
			$css_build = '';
			$css_build .= $text_color ? $cssname.' .gform_wrapper{color:'.$text_color.'}' : null;
			$css_build .= $link_color ? $cssname.' .gform_wrapper a{color:'.$link_color.'}' : null;
			$css_build .= $link_hover_color ? $cssname.' .gform_wrapper a:hover{color:'.$link_hover_color.'}' : null;
			$css_build .= $input_color ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{color:'.$input_color.'}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{color:'.$input_hover_color.'}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{color:'.$input_hover_color.'}' : null;
			$css_build .= $input_hover_color ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{color:'.$input_hover_color.'}' : null;
			$css_build .= $input_bg ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{background-color:'.$input_bg.'}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{background-color:'.$input_hover_bg.'}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{background-color:'.$input_hover_bg.'}' : null;
			$css_build .= $input_hover_bg ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{background-color:'.$input_hover_bg.'}' : null;
			$css_build .= $input_border_color ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{border-color:'.$input_border_color.'}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{border-color:'.$input_border_hover.'}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{border-color:'.$input_border_hover.'}' : null;
			$css_build .= $input_border_hover ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{border-color:'.$input_border_hover.'}' : null;
			$css_build .= $input_border ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{border-style:solid;border-width:'.$input_border.'px;}' : null;
			...
			$css_build .= $input_border_radius ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{border-radius:'.$input_border_radius.';}' : null;
			...
			$css_build .= $input_transparent ? ''. $cssname.' .gform_wrapper input, '. $cssname.' .gform_wrapper select, '. $cssname.' .gform_wrapper textarea{opacity:'.$input_transparent.';}' : null;
			$css_build .= $input_transparent_hover ? ''. $cssname.' .gform_wrapper input:hover, '. $cssname.' .gform_wrapper select:hover, '. $cssname.' .gform_wrapper textarea:hover{opacity:'.$input_transparent_hover.'}' : null;
			$css_build .= $input_transparent_hover ? ''. $cssname.' .gform_wrapper input:focus, '. $cssname.' .gform_wrapper select:focus, '. $cssname.' .gform_wrapper textarea:focus{opacity:'.$input_transparent_hover.'}' : null;
			$css_build .= $input_transparent_hover ? ''. $cssname.' .gform_wrapper input:active, '. $cssname.' .gform_wrapper select:active, '. $cssname.' .gform_wrapper textarea:active{opacity:'.$input_transparent_hover.'}' : null;

			$css_build .= $btn_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{color:'.$btn_color.'}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{color:'.$btn_hover_color.'}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{color:'.$btn_hover_color.'}' : null;
			$css_build .= $btn_hover_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{color:'.$btn_hover_color.'}' : null;
			$css_build .= $btn_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{background-color:'.$btn_bg.'}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{background-color:'.$btn_hover_bg.'}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{background-color:'.$btn_hover_bg.'}' : null;
			$css_build .= $btn_hover_bg ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{background-color:'.$btn_hover_bg.'}' : null;
			$css_build .= $btn_border_color ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{border-color:'.$btn_border_color.'}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{border-color:'.$btn_border_hover.'}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{border-color:'.$btn_border_hover.'}' : null;
			$css_build .= $btn_border_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{border-color:'.$btn_border_hover.'}' : null;
			$css_build .= $btn_border ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{border-style:solid!important;border-width:'.$btn_border.'px!important;}' : null;
			if($btn_border_style) {
			...
			$css_build .= $btn_transparent ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]{opacity:'.$btn_transparent.';}' : null;
			$css_build .= $btn_transparent_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:hover{opacity:'.$btn_transparent_hover.'}' : null;
			$css_build .= $btn_transparent_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:focus{opacity:'.$btn_transparent_hover.'}' : null;
			$css_build .= $btn_transparent_hover ? ''. $cssname.' .gform_wrapper .gform_footer input[type="submit"]:active{opacity:'.$btn_transparent_hover.'}' : null;
